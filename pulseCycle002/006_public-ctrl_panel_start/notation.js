...
var buttonW = ctrlW - 6;
generateNotationButton.style.width = buttonW.toString()+"px";
generateNotationButton.style.height = '30px';
generateNotationButton.style.position = 'absolute';
generateNotationButton.style.left = '3px';
generateNotationButton.style.top = '3px';
// generateNotationButton.style.background = 'white';
generateNotationButton.style.color = 'white';
generateNotationButton.style.fontSize = '14px';
generateNotationButton.style.fontFamily = 'lato';
generateNotationButton.style.border = '0px';
generateNotationButton.style.borderRadius = '9px';
generateNotationButton.style.outline = 'none';

generateNotationButton.id =  'generateNotationButton';
generateNotationButton.innerText =  'Generate Notation';
generateNotationButton.className =  'button1';
console.log(generateNotationButton);
