...
// START UP /////////////////////////////////////////////////////////////
mkPc(notationObjectsIx, "Pulse Cycle 001", 500, 500, 89, 21);
notationObjectsIx++;
startPiece();
...
//notationObjects -> [ svgCanvas, pie, dialArr[dial, deg, spd, r],  mins   jsPanel]
function update(aMSPERFRAME, currTimeMS) {
  ...
  //notationObjects -> [ svgCanvas, pie, dialArr[dial, deg, spd, r],  mins   jsPanel]
  //make separate functions for each conponent: dial, cycle, canvas
  //MAKE SVG CANVAS ------------------------------------------ //
  ...
  function mkPulseCycle(ix, mytitle, w, h, ibpm, numBtsPerCyc) {
    var tno = {};
    var tkey = "no" + ix;
    // Make Canvas //
  ...
  /*
  Make separate functions for each OBJECTS
  Turn Notation Objects into dictionary/object
  Make Dial a separate object
  Ratio: 9/11/13
  Practice it
